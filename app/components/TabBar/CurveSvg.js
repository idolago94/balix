...
export default function CurveSvg(props) {
    ...
    const h = -25;
    return (
      <Svg height={sizes.barHeight*2.8} width={window_width} style={{position: 'absolute', top: (sizes.barHeight+30)*-1, left: 0}}>
        <Defs>
            <LinearGradient id="grad" x1="0" y1="0" x2="0" y2="1">
                <Stop offset="21%" stopColor={colors.notch} stopOpacity="1" />
